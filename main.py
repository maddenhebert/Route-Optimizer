...
with open("./csv/packages.csv") as packages:
    ...
    for row in reader:
        ...
        packages_table[package_id]  = package
...
g1, efficient_route1 = routing.a_star_routing(truck1, distance_matrix, address_dict, packages_table)
g2, efficient_route2 = routing.a_star_routing(truck2, distance_matrix, address_dict, packages_table)
g3, efficient_route3 = routing.a_star_routing(truck3, distance_matrix, address_dict, packages_table)
g3 = round(g3, 2)
final_mileage = g1 + g2 + g3
print(f'TOTAL MILEAGE: {final_mileage}\nSPLIT {g1, g2, g3}\nTRUCK ONE {efficient_route1}\nTRUCK TWO {efficient_route2}\nTRUCK THREE {efficient_route3}')
